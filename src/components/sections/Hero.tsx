    ...
    >
      ...
      <div className="relative mx-auto w-full max-w-6xl px-5 sm:px-8">
        <motion.div variants={stagger} initial="hidden" animate="show">
          ...
          <motion.h1
            variants={reveal}
            className="text-balance font-display text-[3.25rem] font-bold leading-[0.95] tracking-tight sm:text-7xl lg:text-8xl"
          >
            {name}
          </motion.h1>
          ...
          <motion.div variants={reveal} className="mt-8">
            <span className="block text-balance font-display text-4xl font-bold leading-tight sm:text-6xl">
              <span className="text-gradient-amber">{hero.headline}</span>
            </span>
            <p className="mt-4 max-w-xl text-balance text-sm text-faint sm:text-base">
              {hero.description}
            </p>
          </motion.div>
          ...
          <motion.p variants={reveal} className="mt-8 text-xs uppercase tracking-[0.3em] text-faint">
            {role}
          </motion.p>
        </motion.div>
      </div>
